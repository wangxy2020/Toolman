...
/** Mirrors desktop `SocialIconGrid` brand marks. */
export function IconWechat({ size = 20, color = '#07c160' }: IconProps) {
  return (
...
export function IconDouyin({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path
        fill={color}
...
export function IconGoogle({ size = 20 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path
        fill="#4285F4"
...
export function IconApple({ size = 20, color = 'currentColor' }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path
        fill={color}
