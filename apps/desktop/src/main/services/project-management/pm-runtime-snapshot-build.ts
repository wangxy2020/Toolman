...
export function buildProjectResourceCatalogSummaries(
...
export function buildProjectCostCatalogSummaries(
  projects: ReadonlyArray<{
    id: string
    code: string
    name: string
...
export function buildFeatureCatalogSummaryFromProjects(
  projects: ReadonlyArray<{
    code: string
    name: string
    metadata: Record<string, unknown> | null
