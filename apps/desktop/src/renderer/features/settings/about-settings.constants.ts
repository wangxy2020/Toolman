...
export const TOOLMAN_JOIN_US_WELCOME_LINE1 = '欢迎加入Toolman创造者社区！'
export const TOOLMAN_JOIN_US_WELCOME_LINE2 = `QQ群：${TOOLMAN_JOIN_US_QQ_GROUP}，QQ：${TOOLMAN_JOIN_US_QQ}`
