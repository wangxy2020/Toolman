import { KnowledgeCreateSourceSummary } from './KnowledgeCreateSourceSummary'
import type { KnowledgeCreateModalProps } from './knowledge-create-types'
import { useKnowledgeCreateModal } from './useKnowledgeCreateModal'

export type { KnowledgeCreateInput, KnowledgeSourcePick } from './knowledge-create-types'

export function KnowledgeCreateModal(props: KnowledgeCreateModalProps) {
  const { onClose } = props
  const state = useKnowledgeCreateModal(props)
  const {
    t,
    name,
    setName,
              ...
              <div className="tm-agent-setting-row tm-agent-setting-row--top">
                ...
                <div className="tm-kb-kind-radio-group" role="radiogroup" aria-label={t('modals.knowledgeCreate.typeAria')}>
                  <label className="tm-kb-kind-radio">
                    <input type="radio" name="kb-kind" checked={kind === 'local'} onChange={() => setKind('local')} />
