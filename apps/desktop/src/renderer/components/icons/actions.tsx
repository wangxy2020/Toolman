...
export function IconGantt({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="9" y="13" width="10" height="3" rx="1" />
    </svg>
  )
}

/** App-grid / features — distinct from file icons. */
export function IconApps({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
