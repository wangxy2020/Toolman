...
export function IconAgent({ size = 20 }: IconProps) {
  return (
...
export function IconKnowledge({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function IconWorkflow({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M12 3v4" />
      <path d="M12 17v4" />
      ...
      <path d="M7.05 7.05 9.5 9.5" />
      <path d="M14.5 14.5l2.45 2.45" />
      <path d="M16.95 7.05 14.5 9.5" />
      <path d="M9.5 14.5 7.05 16.95" />
    </svg>
  )
}
...
export function IconCommunity({ size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function IconEmoji({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <circle cx="12" cy="12" r="10" />
      <path d="M8 14s1.5 2 4 2 4-2 4-2" />
      <line x1="9" y1="9" x2="9.01" y2="9" strokeWidth="2.4" strokeLinecap="round" />
      <line x1="15" y1="9" x2="15.01" y2="9" strokeWidth="2.4" strokeLinecap="round" />
    </svg>
  )
}
...
export function IconFolderPlus({ size = 18, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconThinking({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 3c-1.2 1.8-3.4 2.6-3.4 5.1 0 1.2.5 2.2 1.3 3" />
      <path d="M12 3c1.2 1.8 3.4 2.6 3.4 5.1 0 1.2-.5 2.2-1.3 3" />
      <path d="M8.2 14.8C6.5 16.1 5 17.8 5 20h14c0-2.2-1.5-3.9-3.2-5.2" />
      <path d="M9.5 11.1 12 8.5l2.5 2.6" />
    </svg>
  )
}
...
export function IconGitFork({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M6 8.5v7" />
      <path d="M8.5 6h5a4.5 4.5 0 0 1 4.5 4.5v1.5" />
    </svg>
  )
}

export function IconSaveNote({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
...
export function IconMoreHorizontal({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export function IconSort({ size = 14, ascending = false }: IconProps & { ascending?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconTerminalPrompt({ size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSlash({ size = 18 }: IconProps) {
  return (
    <span
      className="tm-icon-slash"
...
export function IconSlashCommand({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function IconShortcut({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function IconMcp({ size = 18 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
...
export function IconAccess({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M12 3l7 4v5c0 4.2-2.9 7.4-7 9-4.1-1.6-7-4.8-7-9V7l7-4z" />
      <circle cx="12" cy="11" r="2.2" />
      <path d="M9.2 13.8c.8 1.1 2 1.7 2.8 1.7s2-.6 2.8-1.7" />
    </svg>
  )
}

export function IconLock({ size = 16, className, locked = true }: IconProps & { locked?: boolean }) {
  if (!locked) {
    return (
      <svg
        width={size}
...
export function IconSubscribe({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSkill({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMessageBoard({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRecommend({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconThumbUp({
  ...
  return (
    ...
    >
      <path d="M7 10v12" />
      <path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z" />
    </svg>
  )
}
...
export function IconThumbDown({
  ...
  return (
    ...
    >
      <path d="M17 14V2" />
      <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88Z" />
    </svg>
  )
}
...
export function IconFlag({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M4 22V4a1 1 0 0 1 1-1h1v19" />
