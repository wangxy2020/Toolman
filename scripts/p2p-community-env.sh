...
export COMMUNITY_HUB_DEV_TEST_ROLES="${COMMUNITY_HUB_DEV_TEST_ROLES:-false}"
...
# Dev terminal: warn/error + key startup lines only (set TOOLMAN_CONSOLE_LOG_LEVEL=info for verbose)
export TOOLMAN_CONSOLE_LOG_LEVEL="${TOOLMAN_CONSOLE_LOG_LEVEL:-warn}"
export TOOLMAN_VITE_LOG_LEVEL="${TOOLMAN_VITE_LOG_LEVEL:-warn}"
