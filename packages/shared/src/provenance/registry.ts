...
export const TOOLMAN_PROVENANCE_REGISTRY = {
  ...
  beacons: {
    ...
    callSites: {
      ...
      mobileDiagnosticsView: 'apps/mobile/src/features/DiagnosticsSettingsPanel.tsx',
    },
  ...
  fileHeaders: {
    ...
    entryPoints: [
      ...
      'apps/desktop/src/main/services/mobile-sync-hub-lifecycle.ts',
      'packages/sync-client/src/index.ts',
      'packages/shared/src/sync/pairing-code.ts',
      'apps/mobile/src/features/openKnowledgeDocument.ts',
