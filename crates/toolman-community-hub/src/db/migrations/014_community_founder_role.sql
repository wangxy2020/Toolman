-- Add founder (super admin) role and promote the seeded hub owner.

PRAGMA foreign_keys=OFF;

CREATE TABLE IF NOT EXISTS community_users__founder (
  id TEXT PRIMARY KEY NOT NULL,
  identity_id TEXT NOT NULL UNIQUE,
  display_name TEXT NOT NULL,
  avatar_path TEXT,
  bio TEXT,
  role TEXT NOT NULL DEFAULT 'user' CHECK (role IN ('guest', 'user', 'enterprise', 'admin', 'founder')),
...
INSERT INTO community_users__founder
SELECT * FROM community_users;

DROP TABLE community_users;

ALTER TABLE community_users__founder RENAME TO community_users;
