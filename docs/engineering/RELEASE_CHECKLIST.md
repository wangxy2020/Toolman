...
- [ ] Version is `0.2.0-rc.10` (or current `-rc.N`) in `apps/desktop/package.json`
...
- [ ] `pnpm readme:sync-version`（仅同步 README 版本标记，不改手写功能介绍；见 [README_MAINTENANCE.md](./README_MAINTENANCE.md)）
